...
src/sdk-ros/scripts/build_container.sh --service_name zivid_driver --service_package zivid_driver --dockerfile src/flowstate-ros-camera-drivers/flowstate_zivid/flowstate/Dockerfile.service
